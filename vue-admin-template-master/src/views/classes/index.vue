<template>
  <div>
    ...
    >
      ...
      <el-form-item label="专业id" prop="mid">
        <el-input
    ...
    <el-table :data="classesList" class="table-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" label-width="80px">
        ...
        <el-form-item label="专业id" prop="mid">
          <el-input v-model="form.mid" placeholder="请输入专业id" />
        </el-form-item>
      </el-form>
  ...
  methods: {
    ...
    getList() {
      listClasses(this.queryParams).then((response) => {
        this.classesList = response.data.data.list;
    ...
    /** 导出按钮操作 */
    handleExport() {
      window.location.href = "http://localhost:8089/api/classes/export";
    },
    nextClick(val) {
